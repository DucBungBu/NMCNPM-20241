...
public class HoKhauController {
	...
	public void addHoKhauOnAction(ActionEvent event) {
		...
		if (ControllerUtil.isEmptyOrNull(maHoKhau) || ControllerUtil.isEmptyOrNull(diaChi) || ngayLap == null
				|| ngayChuyenDi == null || ControllerUtil.isEmptyOrNull(lyDoChuyen)) {
		...
		boolean confirmed = ControllerUtil.showConfirmationDialog("Xác nhận thêm hộ khẩu mới",
				"Bạn có chắc chắn muốn thêm hộ khẩu có mã " + maHoKhau + " không ?");
		if (confirmed) {
	...
	public void updateHoKhauOnAction(ActionEvent event) {
		...
		boolean confirmed = ControllerUtil.showConfirmationDialog("Xác nhận cập nhật hộ khẩu",
				"Bạn có chắc chắn muốn cập nhật hộ khẩu có mã " + maHoKhau + " không ?");
		if (confirmed) {
	...
	public void deleteHoKhauOnAction(ActionEvent event) {
		...
		boolean confirmed = ControllerUtil.showConfirmationDialog("Xác nhận xóa hộ khẩu",
				"Xóa hộ khẩu này sẽ xóa toàn bộ nhân khẩu trong hộ. Bạn có chắc chắn muốn xóa hộ khẩu có mã "
						+ hoKhau.getMaHoKhau() + " không ?");
		if (confirmed) {
